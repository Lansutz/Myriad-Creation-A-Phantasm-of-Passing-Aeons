namespace CivilizationEvolution.Character
{
 ...
 // bool 默认 false 安全——struct 无初始化器）            public bool ruledUnderRegency;  // 摄政掌权（被架空/护国公/年轻者判定）
 ...
 /// <summary>区域影响力 0-1（该角色在其所在地区[政治圈/文化圈/地理区] /// 的相对影响力——领土规模/声望/周边承认综合——由调用方计算—— /// 伟大者的判定依据：≥0.6=区域内前列[中等偏上]即可——阿尔弗雷德式： /// 未控制整个英格兰但区域内影响力大）</summary>            public float regionalInfluence;
        }
}
