...
namespace CivilizationEvolution.Thought
{
 ...
 // 学派间关系        [NonSerialized] public Dictionary<int, float> schoolRelations = new Dictionary<int, float>();


 /// <summary>计算学派综合影响力</summary>        public float CalculateInfluence()
        {
 ...
 /// <summary>每日学派Tick</summary>        public void DailyTick()
        {
 // 传播衰减            spreadPower = Mathf.Lerp(spreadPower, 1f, 0.001f);
        }
    }
}
