...
namespace CivilizationEvolution.Politics
{
 ...
 /// 数据表式（成分 int → 革新 id 列表）；空表=基础可用
    ...
    {
 // ===== A1 最高权力·交接 ===== /// <summary>世袭：部落联盟（王权产生）</summary>
 ...
 // ===== A2 最高权力·分配 ===== /// <summary>全能：无需（基础君权）</summary>
 ...
 // ===== B1 中央权力·交接（选人依据） ===== /// <summary>上级决断：官僚制度</summary>
 ...
 // ===== B2 中央机构 ===== /// <summary>无常设：部落联盟（部落议事）</summary>
 ...
 // ===== C1 地方权力·交接 ===== /// <summary>任命：郡县制/行省制（中央任官）</summary>
 ...
 // ===== C2 地方权力·分配 ===== /// <summary>全权自治：部落联盟/邦联（自治传统）</summary>
 ...
 // ===== D 央地结构 ===== /// <summary>单一制：中央集权</summary>
