...
namespace CivilizationEvolution.War
{
 ...
 // ===== 军事系统常量 ===== /// <summary>每个人口块代表的人数（从50改为100，方便军队编制/补员/征兵计算）</summary>
 ...
 // ===== 伤亡率与战斗状态 ===== /// <summary>原始满编兵力（战斗开始时记录，用于计算伤亡率和战斗结束判定）</summary>
 ...
 // 组织度、士气、训练度修正 // 训练度50为基准，100时+15%战斗力，0时-15%
 ...
 // 补给不足：组织度和士气下降 // 训练度越高，组织度掉的越慢（训练度100时降低50%损耗）
            if (supply <= 0f)
            {
 ...
 /// 返回 true=逃跑，false=死战/投降。
        ...
        {
 // 指挥官能力越高，越懂得适时撤退（但也可能死战） // 基础逃跑概率 = 50%，受以下修正：
