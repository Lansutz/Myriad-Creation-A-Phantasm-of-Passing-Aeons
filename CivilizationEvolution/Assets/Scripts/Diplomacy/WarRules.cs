...
namespace CivilizationEvolution.Diplomacy
{
 ...
 /// 数值为战争系统的全局参数，数据驱动后续可 JSON 化
    ...
    {
 // ===== 停战与和平 ===== /// <summary>停战年限（和平条约后强制休战）</summary>
 ...
 // ===== 介入与义务 ===== /// <summary>允许联盟介入战争（防御同盟义务触发）</summary>
 ...
 // ===== 战争分数（score 体系） ===== /// <summary>野战胜利得分</summary>
 ...
 // ===== 投降与终结 ===== /// <summary>小国投降上限（失去省份 ≤ 此数时可能整体投降）</summary>
