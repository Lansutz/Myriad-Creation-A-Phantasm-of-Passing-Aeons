...
namespace CivilizationEvolution.World.Terrain
{
 ...
 // ===== 核心：3D Simplex 噪声 ===== /// 3D Simplex 噪声，输出范围约 [-1, 1]
 ...
 // ===== fBm 分形布朗运动（多倍频叠加）===== /// 分形布朗运动：多倍频 Simplex 噪声叠加
 ...
 // ===== 域扭曲 Domain Warping ===== /// 域扭曲：用噪声场偏移输入坐标，再采样主噪声
 ...
 // ===== 工具函数 ===== /// <summary>Smootherstep 平滑插值（比 smoothstep 更平滑，二阶导数连续）</summary>
