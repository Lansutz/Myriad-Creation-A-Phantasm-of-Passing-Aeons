...
namespace CivilizationEvolution.Politics
{
    ...
    {
 // 顺序对应 ClassNeedDimension 枚举：Subsistence/Security/TaxBurden/PoliticalAccess/ // EconomicOpportunity/InstitutionalRecognition/Legitimacy/Privilege        public float[] royalty =        { 0.10f, 0.20f, 0.00f, 0.00f, 0.15f, 0.00f, 0.30f, 0.25f };
