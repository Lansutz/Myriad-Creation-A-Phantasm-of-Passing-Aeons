...
namespace CivilizationEvolution.Culture
{
 ...
 /// <summary>治理头衔（官僚=titleId[郡守…]/分封=领主爵位——TitleDef 键）</summary>        public string titleId = "";
 /// <summary>治理者（官僚=官员 charId——分封=领主 charId——-1=空缺）</summary>        public int holderCharacterId = -1;
    }
}
