...
{
 /// 教义选项池（支柱选项——CK3 tenets 结构参考：中性词汇+宗教专属风味化） /// 每个支柱下有选项池——节点从池中选择——选项差异决定偏离度

 /// <summary>教义选项池（ReligionCatalog 加载 Doctrines.json）</summary>    public static class DoctrinePool
    {
 ...
 /// <summary>某支柱的可用选项（宗教专属过滤：exclusiveReligionIds 空=通用， /// 非空=仅匹配宗教）</summary>        public static List<DoctrineOptionDef> GetOptions(string pillar, int religionId)
        {
