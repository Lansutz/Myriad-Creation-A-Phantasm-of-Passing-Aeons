...
namespace CivilizationEvolution.Core
{
 ...
 /// <summary>政体七维成分组合（整体序列化；GovernmentComposition 及其成员类全部 [Serializable]，无 Dictionary）</summary>        public GovernmentComposition composition = new GovernmentComposition();
        ...
        {
 // 构造函数会初始化 classRelations 默认值与 taxSystem/currencySystem，随后整体覆盖            var r = new RealmData
            {
                realmId = realmId,
                realmName = realmName,
