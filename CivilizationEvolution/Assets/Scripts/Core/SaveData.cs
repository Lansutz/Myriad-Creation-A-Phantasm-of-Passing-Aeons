...
namespace CivilizationEvolution.Core
{
 ...
 // 世界配置        public int mapWidth;
        public int mapHeight;
        public int currentYear;
        public int currentDay;
        public int currentSeason;

 // 核心数据（TileData/CultureData/GoodsDef/TradeRoute 无字典，可直接序列化）        public TileData[] tiles;
 ...
 // 战争状态（WarState 无字典字段，可直接序列化——读档恢复战争闭环）        public List<WarState> wars;
    }
}
